    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/restaurantes").permitAll()
                        //Restricciones a restauranteController
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/restaurantes/*/platos")
                                .hasAnyAuthority("ROLE_ADMIN", "ROLE_RESTAURANTE")

                                .requestMatchers(HttpMethod.PUT, "/api/v1/restaurantes/*/platos/*")
                                .hasAnyAuthority("ROLE_ADMIN", "ROLE_RESTAURANTE")

                                .requestMatchers( "/api/v1/restaurantes/*/platos/*/promocion/**")
                                .hasAnyAuthority("ROLE_ADMIN", "ROLE_RESTAURANTE")
                        ...
                        .requestMatchers("/api/v1/usuarios/*", "/api/v1/usuarios/email/*")
                        .hasAuthority("ROLE_ADMIN")
                        ...
                        .requestMatchers("/api/v1/usuarios/*/favoritos/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
