...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleFavoritoYaExistente(FavoritoYaExisteException ex) {
        ...
        ErrorResponseDTO response = new ErrorResponseDTO(LocalDateTime.now(), "Ese restaurante ya existe en la lista de favoritos");

        return ResponseEntity.status(HttpStatus.CONFLICT).body(response);
    }

    @ExceptionHandler(FavoritoInexistenteException.class)
    public ResponseEntity<ErrorResponseDTO> handleFavoritoNoExiste(FavoritoInexistenteException ex) {

        ErrorResponseDTO response = new ErrorResponseDTO(LocalDateTime.now(), "Ese restaurante no existe en la lista de favoritos");
